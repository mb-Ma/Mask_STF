...
from models.AGCRN import AGCRN as Network
from models.BasicTrainer import Trainer
from utils.TrainInits import init_seed
from utils.TrainInits import print_model_parameters
from utils.mela import get_dataloader
from pathlib import Path

#*************************************************************************#
Mode = 'train'
DEBUG = 'False'
# DATASET = 'MELA'      #PEMSD4 or PEMSD8
DATASET = 'MELA1'      #PEMSD4 or PEMSD8, incremental
DEVICE = 'cuda:0'
MODEL = 'AGCRN'
...
args.add_argument('--d', default='meta-35_65-20-10-5-10_12.npz', type=str)
...
train_loader, val_loader, test_loader, scaler, _ = get_dataloader(root / args.d, args.batch_size, incre_num=2)
